...
module.exports = async function runRateAndMessageMultipleLadies(page, tierConfigs) {
  ...
  const excludedLadyNames = new Set([
    ...
    'LIZYSOFLY','R A M O','jannat 123','BASSANT','Farooh','Rosie','Amara','HorseyHeather','waso','NOT_ban','Алёна','freesia','Kinsey','Shilo','Regina','Carol','Kallee','Paula','Baker','Farah Moan','mazikeen','Michelle',
    ...
    'katrina','QUEEN OF MEAN','alain dz','miri0','Melina','𝐓𝐚𝐧𝐉𝐢𝐫𝐨𝐮','Chantilly Lace','H ..','vera Baddie','Delfinche',
    // add all names you want to exclude
  ].map(n => n.toLowerCase())); // convert to lowercase for case-insensitive matching

  const m1 = '🦉💕 Thank you for owl your support, my sweet friend! Olive you sooo much! 🌿💚✨ Wishing you lots of reasons to smile! ฅ≽^•⩊•^≼ฅ 💖💖💖💖💖💖💖💖💖💖💖💖';
  const m2 = '🦉💕 Thank you for owl your support, my sweet friend! Olive you sooo much! 🌿💚✨ Wishing you lots of reasons to smile! ฅ≽^•⩊•^≼ฅ 💖💖💖💖💖💖💖💖💖💖💖💖'; //already won
  const m3 = '🦉💕 Thank you for owl your support, my sweet friend! Olive you sooo much! 🌿💚✨ Wishing you lots of reasons to smile! ฅ≽^•⩊•^≼ฅ 💖💖💖💖💖💖💖💖💖💖💖💖'; //168
